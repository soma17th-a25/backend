"""CLI로 generate_node 단독 실행 (mock 입력 사용)."""
import asyncio
import logging
import os
import sys
    ...
    "retrieved_docs": [
        {
            ...
            "content": "누구든지 술에 취한 상태에서 자동차 등을 운전하여서는 아니 된다. "
                       ...
                       "술에 취한 상태에서 자동차 등을 운전하였다고 인정할 만한 상당한 이유가 있는 경우에는 "
        ...
        },
        {
            ...
            "content": "혈중알코올농도가 0.03% 이상 0.08% 미만인 사람은 1년 이하의 징역이나 500만원 이하의 벌금. "
                       "혈중알코올농도가 0.08% 이상 0.2% 미만인 사람은 1년 이상 2년 이하의 징역이나 "
