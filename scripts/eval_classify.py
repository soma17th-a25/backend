"""평가셋 10개를 실제 Solar API로 돌려 정확도 csv 출력.

RPM 초과 방지를 위해 호출 사이에 7초 딜레이를 둔다.
Upstage 플랜에 따라 CALL_DELAY와 MAX_EVAL을 조정할 것.
"""
import asyncio
import csv
import json
...
MAX_EVAL = 10        # gemini-2.5-flash-lite 10 RPM에 맞춰 10개로 제한
CALL_DELAY = 7.0     # 호출 간격 (초) — 10 RPM = 6초 간격, 1초 여유
